...
export function SiteHeaderClient({ userName }: { userName: string | null }) {
  ...
  return (
    <header className="sc-hdr">
      ...
      {userName ? (
        <form action={signOut} className="sc-hdr__viewer">
          <input type="hidden" name="path" value={pathname} />
          <span className="sc-hdr__viewer-text">
            Viewing as <strong>{userName}</strong>
          </span>
          <button type="submit" className="sc-btn sc-btn--ghost sc-btn--sm">
            Not you?
          </button>
        </form>
      ) : null}
